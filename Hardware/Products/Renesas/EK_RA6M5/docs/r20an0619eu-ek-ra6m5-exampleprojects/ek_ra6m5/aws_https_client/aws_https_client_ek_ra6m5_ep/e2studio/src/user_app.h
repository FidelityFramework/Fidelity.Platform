...
#define HTTPS_GET_API   "/api/v2/<username>/feeds/<feed_key>/data?limit=1"
 ...
 **/
#define HTTPS_PUT_POST_API    "/api/v2/<username>/feeds/<feed_key>/data/"

/** @brief User has to update their generated active key from the io.adafruit.com server. */
#define ACTIVE_KEY                             "<ADAFRUIT_IO_KEY>"
